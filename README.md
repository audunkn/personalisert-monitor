...
Over tid lærer systemet hva jeg finner nyttig. Det skjer gjennom en innebygd vurderingsmekanisme: jeg godkjenner eller avviser sammendrag med en kommentar på hvorfor, og systemet bruker disse tilbakemeldingene til å stille inn seg selv på akkurat min måte å tenke på.
