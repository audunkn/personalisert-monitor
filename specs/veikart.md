...
Rammeverket automatiserer det du ellers ville gjort manuelt: laster datasett, kjører komponenten, måler mot kriterier og aggregerer til rapport. Med `make regresjon` får du en fullstendig rapport i stedet for manuell steg-for-steg-kjøring i terminalen.
...
Tre profiler (strategisk, operasjonelt, teknisk) sikrer dekning av ulike informasjonsbehov.
